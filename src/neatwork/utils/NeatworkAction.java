...
public abstract class NeatworkAction extends AbstractAction {
	...
	private static final long serialVersionUID = -5167809825417260909L;

	public NeatworkAction(String name, Icon icon, String description, char mnemonic) {
		this(name, icon, description, new Integer(mnemonic));
	}

	public NeatworkAction(String name, Icon icon, String description, Integer mnemonic) {
		setName(name);
		setSmallIcon(icon);
