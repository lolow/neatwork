...
public class Simulation extends Project {
    ...
    public Properties getProperties() {
        ...
        for (Enumeration e = data.elements(); e.hasMoreElements();) {
            ...
            //properties
            if ((t.size() == 3)) {
                prop.setProperty("simu." + t.get(0).toString() + ".value",  
                    t.get(1).toString());
            }
        }
    ...
    public Vector getFlowTaps() {
        String[] type = { "S", "I", "D", "D", "D", "D", "D", "D", "I" };   //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$

        return getLine(10, type);
    }

    public Vector getQuartileTaps() {
        String[] type = { "S", "I", "D", "D", "D", "D", "D", "D", "D" };   //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$

        return getLine(11, type);
    }

    public Vector getSpeedPipe() {
        String[] type = { "S", "I", "D", "D" };   //$NON-NLS-3$ //$NON-NLS-4$

        return getLine(5, type);
    }

    public Vector getNodesPressure() {
        String[] type = { "S", "D", "D", "D" };   //$NON-NLS-3$ //$NON-NLS-4$
