...
public class DBDiameterTableModel extends FancyTableModel {
	private String[] myHeader = { Messages.getString("DBDiameterTableModel.Nominal"),
			Messages.getString("DBDiameterTableModel.SDR"), Messages.getString("DBDiameterTableModel.Diameter"),
			Messages.getString("DBDiameterTableModel.Cost/m"), Messages.getString("DBDiameterTableModel.Max_Pressure"),
			Messages.getString("DBDiameterTableModel.Type"), // $NON-NLS-3$
																// //$NON-NLS-4$
																// //$NON-NLS-5$
																// //$NON-NLS-6$
