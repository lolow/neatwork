...
public class DesignLoadFactorDialog extends JDialog implements ActionListener {
	...
	public DesignLoadFactorDialog(JFrame frame, Design design) {
		...
		pane.add(
				new FancyTablePanel(Messages.getString("DesignLoadFactorDialog.These_are_the_load_factors_used_by")
						+ Messages.getString("DesignLoadFactorDialog.the_MAKE_DESIGN_operation_for_building")
						+ Messages.getString("DesignLoadFactorDialog._this_design"), null, table, true),
				BorderLayout.CENTER);
