...
public class DesignNodeModel extends FancyTableModel {
	private String[] headerNode = { Messages.getString("DesignNodeModel.ID"),
			Messages.getString("DesignNodeModel.Height"), Messages.getString("DesignNodeModel.X"),
			Messages.getString("DesignNodeModel.Y"), Messages.getString("DesignNodeModel.Ideal_Orifice"),
			Messages.getString("DesignNodeModel.Commercial_Orifice"), // $NON-NLS-3$
																		// //$NON-NLS-4$
																		// //$NON-NLS-5$
																		// //$NON-NLS-6$
