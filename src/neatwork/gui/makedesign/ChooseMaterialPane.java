...
public class ChooseMaterialPane extends JPanel {
	...
	public ChooseMaterialPane(Database database, Topographie topographie) {
		...
		actions[1].putValue(Action.SHORT_DESCRIPTION, Messages.getString("ChooseMaterialPane.Select_none"));
		...
		actions[0].putValue(Action.SHORT_DESCRIPTION, Messages.getString("ChooseMaterialPane.Select_all"));

		JPanel diamPanel = new FancyTablePanel(Messages.getString("ChooseMaterialPane.Diameters"), actions, diamTable,
				false);
		...
		JPanel orifPanel = new FancyTablePanel(Messages.getString("ChooseMaterialPane.Orifices"), actions, orifTable,
				false);
