...
/**
 * Boite de dialogue qui montre la progression de resolution
 * 
 * @author L. DROUET
 * @version 1.0
 */
public class SolverProgressDialog extends JDialog implements Observer, ActionListener {
	...
	public SolverProgressDialog(AbstractSolver solver, Thread thread) {
		...
		buttonClose = new JButton(Messages.getString("SolverProgressDialog.Close"));
