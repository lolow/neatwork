 ...
 * @version 1.0
 */
public class FileManagerDialog extends JDialog implements Observer,
    ...
    public FileManagerDialog(JFrame frame, AbstractFileManager fileManager,
                    ...
                    public void actionPerformed(ActionEvent e) {
                        if (!jTextField.getText().equals("")) { 
                            ...
                            if ((!isInList(jTextField.getText())) ||
                                ...
                                getFileManager().deleteFile(jTextField.getText(),
                                    typeFile);

                                if (getFileManager().writeFile(jTextField.getText(),
                                            getContent(), typeFile)) {
                                    setCancelled(false);
                                    setVisible(false);
                                }
    ...
    private void textChanged(DocumentEvent e) {
        boolean inList = isInList(jTextField.getText());
