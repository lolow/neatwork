...
/**
 * Title: Neatwork2 Description: Water distribution network designer Copyright:
 * Copyright (c) 2002 Company: LOGILAB - University of Geneva
 * 
 * @author L. DROUET
 * @version 1.0
 */
public class SingleRowTabbedPaneUI extends MetalTabbedPaneUI {
	...
	/*
	 * DEPRECATED protected FontMetrics getFontMetrics() { Font font =
	 * tabPane.getFont(); //return
	 * Toolkit.getDefaultToolkit().getFontMetrics(font); return null; }
	 */
	...
	class SingleRowTabbedLayout extends BasicTabbedPaneUI.TabbedPaneLayout {
		...
		public void layoutContainer(Container parent) {
			...
			if (tabPlacement == TOP) { // TOP
				...
				y = (bounds.y + bounds.height) - insets.bottom - tabAreaInsets.bottom - maxTabHeight;
			}
		...
		protected void calculateTabWidths(int tabPlacement, int tabCount) {
			...
			// FontMetrics metrics =
			// Toolkit.getDefaultToolkit().getFontMetrics(tabPane.getFont());
